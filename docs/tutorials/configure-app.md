...
<head>
  <meta name="description"
        content="The largest community created tech conference in the UK, carefully crafted for you by the GDG community and UCL! GDG (Google Developer Group) London is a group of developers passionate about Google technologies with a strong focus on knowledge exchange and networking. Learn about Android, Web, Cloud, Machine Learning and more from world experts.">
  <meta name="keywords"
